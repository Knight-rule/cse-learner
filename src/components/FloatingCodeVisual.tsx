  ...
  return (
    <div ref={containerRef} className="hero-3d-visual" style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(139,94,60,0.15) 0%, rgba(166,123,91,0.08) 50%, transparent 70%)",
      ...
      {[
        { x: "50%", y: "18%", size: 56, color: "#8B5E3C", label: "DS", delay: 0 },
        { x: "22%", y: "42%", size: 48, color: "#A67B5B", label: "Algo", delay: 0.3 },
        ...
        { x: "50%", y: "50%", size: 64, color: "#8B5E3C", label: "CSE", delay: 0.15 },
      ].map((node, i) => (
        <div
          key={i}
      ...
      <svg viewBox="0 0 400 400" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", zIndex: 1 }}>
        <defs>
          <linearGradient id="line-grad" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="100%" stopColor="#A67B5B" stopOpacity="0.3" />
          </linearGradient>
        </defs>
        {/* DS → Algo */}
      ...
      <div style={{
        ...
        border: "1px solid rgba(166,123,91,0.06)",
        borderRadius: "50%",
