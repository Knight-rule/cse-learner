    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-bottom" style={{ flexDirection: "column", gap: 8 }}>
          ...
          <p className="footer-copy" style={{ fontSize: 10, opacity: 0.35, fontFamily: "monospace" }}>build {process.env.RENDER_GIT_COMMIT || process.env.NEXT_PUBLIC_BUILD_ID || "dev"}</p>
