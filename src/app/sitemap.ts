...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = ["", "/about", "/courses", "/practice", "/languages", "/jobs", "/contests", "/notepad", "/certificates", "/internships", "/leaderboard", "/dashboard", "/ai-mentor", "/contact", "/paths", "/bookmarks"].map((path) => ({
    url: BASE + path,
    lastModified: now,
