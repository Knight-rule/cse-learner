...
import { ChevronRight, BookOpen, Code, Play } from "lucide-react";
...
const difficultyColors: Record<string, string> = {
  ...
  "Intermediate-Advanced": "bg-orange-100 text-orange-700",
  ...
  return (
    <div className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header */}
        <div className="mb-12">
          <div className="inline-flex items-center gap-2 bg-primary-50 rounded-full px-4 py-1.5 text-sm font-medium text-primary-700 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {languages.map((lang) => (
            <Link
              ...
              className="group relative bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 overflow-hidden"
            >
              {/* Color bar */}
              ...
              <div className="p-8">
                ...
                <p className="text-dark-500 mb-6">{lang.description}</p>

                {/* Use Cases */}
                <div className="flex flex-wrap gap-2 mb-6">
                  {lang.useCases.map((uc) => (
                    <span key={uc} className="bg-dark-50 text-dark-600 px-3 py-1 rounded-full text-xs font-medium">
                      {uc}
                    </span>
                  ))}
                </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              <thead className="bg-dark-50">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-dark-600">Language</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-dark-600">Typing</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-dark-600">Paradigm</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-dark-600">Compiled/Interpreted</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-dark-600">Best For</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium">🐍 Python</td>
                  <td className="px-6 py-4 text-dark-500">Dynamic</td>
                  <td className="px-6 py-4 text-dark-500">Multi-paradigm</td>
                  <td className="px-6 py-4 text-dark-500">Interpreted</td>
                  <td className="px-6 py-4 text-dark-500">AI, Data Science, Scripting</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium">☕ Java</td>
                  <td className="px-6 py-4 text-dark-500">Static</td>
                  <td className="px-6 py-4 text-dark-500">OOP</td>
                  <td className="px-6 py-4 text-dark-500">Compiled (JVM)</td>
                  <td className="px-6 py-4 text-dark-500">Enterprise, Android</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium">⚙️ C/C++</td>
                  <td className="px-6 py-4 text-dark-500">Static</td>
                  <td className="px-6 py-4 text-dark-500">Procedural / OOP</td>
                  <td className="px-6 py-4 text-dark-500">Compiled</td>
                  <td className="px-6 py-4 text-dark-500">Systems, Game Dev, OS</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium">📜 JavaScript</td>
                  <td className="px-6 py-4 text-dark-500">Dynamic</td>
                  <td className="px-6 py-4 text-dark-500">Multi-paradigm</td>
                  <td className="px-6 py-4 text-dark-500">Interpreted (JIT)</td>
                  <td className="px-6 py-4 text-dark-500">Web (Frontend + Backend)</td>
                </tr>
              </tbody>
            </table>
          </div>
