...
const languages = [
  ...
  { slug: "c-cpp", name: "C & C++", icon: "⚙️", gradient: "linear-gradient(135deg, #3b82f6, #4f46e5)", description: "Low-level control, maximum performance. The foundation of modern computing.", useCases: ["Systems Programming", "Game Dev", "OS", "Embedded", "Competitive Programming"], difficulty: "Intermediate-Advanced", typing: "Static", paradigm: "Procedural / OOP", compiled: "Compiled", bestFor: "Systems, Game Dev, OS" },
