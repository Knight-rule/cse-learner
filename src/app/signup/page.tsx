...
import { Mail, Lock, User, ArrowRight, BookOpen, Code, Target, Shield, Sparkles } from "lucide-react";
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Start your journey to mastering Computer Science
          </p>
        ...
        <div style={{
          ...
          <p style={{
            ...
            Join thousands of CSE students learning together
          </p>
